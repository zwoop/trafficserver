...
struct Cache {
  ...
  Action *lookup(Continuation *cont, const CacheKey *key, CacheFragType type, const char *hostname, int host_len, int volume);
  Action *open_read(Continuation *cont, const CacheKey *key, CacheFragType type, const char *hostname, int len, int volume);
  Action *open_write(Continuation *cont, const CacheKey *key, CacheFragType frag_type, int volume, int options = 0,
                     time_t pin_in_cache = 0, const char *hostname = nullptr, int host_len = 0);
  Action *remove(Continuation *cont, const CacheKey *key, int volume, CacheFragType type = CACHE_FRAG_TYPE_HTTP,
  ...
  Action     *open_write(Continuation *cont, const CacheKey *key, CacheHTTPInfo *old_info, int volume, time_t pin_in_cache = 0,
  ...
  StripeSM *key_to_stripe(const CacheKey *key, const char *hostname, int host_len, int volume);
